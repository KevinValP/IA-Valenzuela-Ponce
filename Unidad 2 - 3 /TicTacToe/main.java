...
public class main {
	 public static void main(String[] args) {
	        ...
	        while (true) {
	            System.out.print("Comando de entrada (start + (easy/medium/hard) + user): ");
	 ...
	 private static char[][] computerMove(char[][] board, char player, String difficulty, int numSpaces) {
	        if (difficulty.equals("easy")) {
	            System.out.println("Realizando movimiento nivel \"easy\"");
	            computerMoveRandom(board, player);
	        } else if (difficulty.equals("medium")) {
	            System.out.println("Realizando movimiento nivel \"medium\"");
	            ...
	            System.out.println("Realizando movimiento nivel \"hard\"");
	 ...
	 private static char[][] userMove(char[][] board, char player, Scanner scanner) {
	        while (true) {
	            System.out.print("Introduzca las coordenadas --x y--: ");
	            ...
	            if (row > board.length || column > board[0].length) {
	                System.out.println("Las coordenadas deben ser del 1 al 3!");
	            } else if (board[row - 1][column - 1] == 'X' || board[row - 1][column - 1] == 'O') {
	                System.out.println("Esta celda ya está ocupada! Elija otra!");
	            } else {
	            ...
	            for (int y = 0; y < board[x].length; y++) {
	                ...
	                if (xCount == sameThreshold || oCount == sameThreshold) {
	                    if (sameThreshold == 2) {
	                        ...
	                        return new Object[]{String.format("%c gana", board[x][y]), board[x][y] == 'X' ? 1 : -1};
	                    }
	                }
	            }
	        }
	    ...
	    private static Object[] isDiagonalVictory(char[][] board) {
	        if (board[0][0] != '_' && board[0][0] == board[1][1] && board[1][1] == board[2][2]) {
	            return new Object[]{String.format("%c gana", board[1][1]), board[1][1] == 'X' ? 1 : -1};
